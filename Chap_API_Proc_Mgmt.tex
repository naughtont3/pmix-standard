...
Note for supported attributes, it is implementation dependent on whether the
attribute is recognized when present in either the \refarg{job_info}, or in
the \textit{info} array of an element of the \refarg{apps} array.
